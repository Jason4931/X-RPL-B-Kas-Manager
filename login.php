...
<body class="d-flex align-items-center py-4 bg-body-tertiary" style="overflow-x: hidden; background-image: url('./gambar/Bruh2.png'); background-repeat: no-repeat; background-size: cover;">
  <main class="container-fluid d-flex align-items-center justify-content-center" style="height: 100vh;">
    <form method="post" class="card p-4 bg-body-secondary shadow-sm mx-4" style="width: 50vw;">
      ...
      <button class="btn bg-primary w-100 py-2 my-2 text-light" type="submit">Login</button>
